                ...
                <section id="select-administration">
                  <div className="point-header">
                    ...
                    <p>
                      ...
                      fornitore contrattualizzato prima del decreto di finanziamento per attività già avviate o
                      realizzate a decorrere dal 1° febbraio 2020.
                      <br />
                      ...
                      , filtrando per area merceologica <strong>“Informatica, elettronica e telecomunicazioni”</strong>,
                      è possibile individuare i cataloghi in questione. Per la misura 1.2 è necessario selezionare
                      <strong>“Servizi Cloud-Mepa”</strong> nella classe merceologica “Servizi ICT”, mentre per la
                      misura 1.4.1 la categoria <strong>“Licenza software-Mepa Servizi”</strong> nella classe
                      merceologica “Software”.
                      <br />
                      <br />
                      Si ricorda che l'ingaggio del fornitore da parte della PA non è vincolato a MePA purché rispetti
                      il rispetti il codice e la normativa vigenti in tema di affidamenti pubblici
                    </p>
                    <h3 className={`${classes.contentTitle} mt-5`}>Approfondimenti</h3>
                    <div className={`${classes.linkWrapper}`}>
                      <a
                ...
                <section id="verify-data">
                  <div className="point-header">
                    ...
                    <p>
                      ...
                      fornitori per svolgere le attività richieste dall’avviso, ma è il primo che farà fede per
                      calcolare la durata massima dei lavori.
                      <br />
                      <br />
