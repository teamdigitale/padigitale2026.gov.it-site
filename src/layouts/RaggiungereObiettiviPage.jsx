            ...
            >
              <Container className="pl-lg-4 mb-4">
                ...
                <section id="role-verifier">
                  ...
                  <p>
                    Dal momento che la PA conferma di aver completato le attività del progetto, cominciano le cosiddette
                    verifiche di conformità tecnica, che variano a seconda dell’Avviso e che sono descritte in questa
                    pagina. Queste verifiche possono includere sia controlli automatici, che il coinvolgimento di un
                    asseveratore, persona incaricata dal Dipartimento per svolgere ulteriori verifiche anche mediante
                    visita o videocall.
                    <br />
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        registri di PagoPa spa; un criterio di conformità dell’avviso “Esperienza del Cittadino nei
                        servizi pubblici” per i Comuni non è rispettato), ma i termini del cronoprogramma non sono
                      ...
                      <li>
                        ...
                        cronoprogramma è scaduto, oppure il progetto risulta non ammissibile (es. doppio finanziamento).
                        Il Dipartimento a questo punto avvia il procedimento di revoca del finanziamento.
                      </li>
                    </ul>
                  </p>
                </section>
                <section id="cloud-enablement">
                  ...
                  <p>
                    ...
                    asseverazione verranno effettuate le verifiche sulle infrastrutture, sul software utilizzato e sulla
                    disponibilità, a valle della migrazione, dei servizi di destinazione selezionati.
                    <br />
                    <br />
                    L’Avviso prevede la possibilità di selezionare due tipologie di migrazione, denominate Trasferimento
                    in sicurezza dell’infrastruttura IT e Aggiornamento di applicazioni sicure in Cloud. A seconda della
                    modalità selezionata, per ognuno dei servizi oggetto della migrazione, verrà applicato un modello di
                    controllo specifico. In particolare poi per tutti i servizi che sono stati migrati utilizzando la
                    modalità “Aggiornamento” verrà effettuato un ulteriore distinguo a seconda che la destinazione
                    finale sia un servizio PaaS Qualificato o un servizio SaaS Qualificato. All’interno della
                    piattaforma PA digitale 2026 il Soggetto Attuatore dovrà indicare, nella scheda di Assessment, lo
                    stato di avanzamento per ognuno dei servizi oggetto di migrazione e per ognuno dei servizi dovrà
                    indicare lo stato della migrazione. Una volta concluso il processo di migrazione il Soggetto
                    Attuatore potrà contrassegnare nella scheda di Assessment la migrazione come completata.
                    <br />
                    <br />A valle di ciò, l’Asseveratore comunicherà le richieste di chiarimenti, documentazione e prove
                    di migrazione utilizzando l’area Richieste all’interno della piattaforma PA digitale 2026. La
                    documentazione richiesta si suddivide in due tipi: Documentazione specifica per la tipologia di
                ...
                <section id="citizen-experience">
                  ...
                  <p>
                    ...
                    necessarie a interpretare i risultati e apportare eventuali migliorie al sito e ai servizi, sia
                    durante la fase di sviluppo (es. lavorazioni in locale) sia alla conclusione dei lavori (es. quando
                    il sito e i servizi sono online e disponibili al pubblico).
                    <br />
                    <br />
                    <ul>
                      <li>
                ...
                <section id="platforms">
                  ...
                  <p>
                    Per gli Avvisi dedicati alle rafforzamento delle principali piattaforme abilitanti, il Dipartimento
                    per la trasformazione digitale si avvale della collaborazione di una serie di soggetti esterni
                    certificatori. Attraverso di essi vengono svolte delle verifiche automatiche grazie all’integrazione
                    con specifici registri e database.
                    <br />
                    <br />
